...
%series 80
fig_name_list = {'vt01_01_NE_die11_jja_north_series80_jj1_01','vt01_01_NE_die11_jja_north_series80_jj2_01','vt01_01_NE_die11_jja_north_series80_jj3_01','vt01_01_NE_die11_jja_north_series80_jj4_01'};
x_data = cell(length(fig_name_list),1);
y_data = cell(length(fig_name_list),1);
for ii = 1:length(fig_name_list)
    open([fig_name_list{ii} '.fig'])
...
h = figure('OuterPosition',[0 0 scrsz(3) scrsz(4)]);
for ii = 1:length(fig_name_list)
    plot(x_data{ii},y_data{ii}*1e3,'Color',bRGY(color_list(ii),:),'LineWidth',2);
    hold on
end
ylabel('Current [\mu A]','FontSize',FontSize,'FontName','Times')
...
fig_name_list = {'vt01_01_NE_die11_jja_north_series80_jj4_01','vt01_01_NE_die11_jja_north_series80_jj4_02'};
x_data = cell(length(fig_name_list),1);
y_data = cell(length(fig_name_list),1);
for ii = 1:length(fig_name_list)
    open([fig_name_list{ii} '.fig'])
...
%series 160
fig_name_list = {'vt01_01_NE_die11_jja_north_series160_jj1_01','vt01_01_NE_die11_jja_north_series160_jj2_01','vt01_01_NE_die11_jja_north_series160_jj3_01','vt01_01_NE_die11_jja_north_series160_jj4_01'};
x_data = cell(length(fig_name_list),1);
y_data = cell(length(fig_name_list),1);
for ii = 1:length(fig_name_list)
    open([fig_name_list{ii} '.fig'])
...
%series 80
fig_name_list = {'vt01_01_NE_die11_jja_west_series80_jj1_01','vt01_01_NE_die11_jja_west_series80_jj2_01','vt01_01_NE_die11_jja_west_series80_jj3_01','vt01_01_NE_die11_jja_west_series80_jj4_01'};
x_data = cell(length(fig_name_list),1);
y_data = cell(length(fig_name_list),1);
for ii = 1:length(fig_name_list)
    open([fig_name_list{ii} '.fig'])
...
%series 160
fig_name_list = {'vt01_01_NE_die11_jja_west_series160_jj1_01','vt01_01_NE_die11_jja_west_series160_jj2_01','vt01_01_NE_die11_jja_west_series160_jj3_01','vt01_01_NE_die11_jja_west_series160_jj4_01'};
x_data = cell(length(fig_name_list),1);
y_data = cell(length(fig_name_list),1);
for ii = 1:length(fig_name_list)
    open([fig_name_list{ii} '.fig'])
...
%comparing 80 to 160
fig_name_list_1 = {'vt01_01_NE_die11_jja_west_series80_jj1_01','vt01_01_NE_die11_jja_west_series80_jj2_01','vt01_01_NE_die11_jja_west_series80_jj3_01','vt01_01_NE_die11_jja_west_series80_jj4_01'};
fig_name_list_2 = {'vt01_01_NE_die11_jja_west_series160_jj1_01','vt01_01_NE_die11_jja_west_series160_jj2_01','vt01_01_NE_die11_jja_west_series160_jj3_01','vt01_01_NE_die11_jja_west_series160_jj4_01'};
x_data_1 = cell(length(fig_name_list_1),1);
y_data_1 = cell(length(fig_name_list_1),1);
x_data_2 = cell(length(fig_name_list_2),1);
y_data_2 = cell(length(fig_name_list_2),1);
